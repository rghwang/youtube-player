    ...
    ui.Pages.define(searchPageURI, {
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                ...
                document.querySelector(".titlearea .pagetitle").textContent = "동영상 검색 결과";
                document.querySelector(".titlearea .pagesubtitle").textContent = "검색 키워드 “" + this._lastSearch + '”';
            }
        },
        ...
        _itemInvoked: function (args) {
            args.detail.itemPromise.done(function itemInvoked(item) {
                ...
                nav.navigate("/pages/split/split.html", { groupKey: item.groupKey, selectedIndex: Data.getIndexInGroup(item) })
            });
        },
